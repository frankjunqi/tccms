...
public class ProductsAction extends BaseAction {
    ...
    public void execute() throws ServletException, IOException {
        ...
        // 图片列表
        root.put("imagelist", JsoupUtil.Images(products.getMessage()));
        List<String> list = JsoupUtil.Images(products.getMessage());
    ...
    public void list() {
        ...
        Info info = _getInfo();
        if (params == null) {
            PageUtil pageutil = pageService.getPage(page, 20, 3);
            ...
            PageUtil pageutil = pageService.getPage(page, 20, filter, new Page());
            root.put("page", pageutil);
