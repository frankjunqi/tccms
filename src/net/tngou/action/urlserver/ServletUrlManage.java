 ...
 */
@WebServlet(urlPatterns = {"/urlserver/*", "/urlserver"},
        initParams = {@WebInitParam(name = "package", value = "net.tngou.action.urlserver")})
public class ServletUrlManage extends HttpServlet {
    private static final long serialVersionUID = 1L;
    private final static Logger log = LoggerFactory.getLogger(ServletUrlManage.class);
