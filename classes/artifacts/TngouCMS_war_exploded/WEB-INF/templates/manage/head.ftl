<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="${Domain.base}/favicon.ico"/>
    ...
    <link rel="stylesheet" href="${Domain.base}/common/kindeditor/themes/default/default.css"/>
    <script charset="utf-8" src="${Domain.base}/common/kindeditor/kindeditor-min.js"></script>
    <script charset="utf-8" src="${Domain.base}/common/kindeditor/lang/zh_CN.js"></script>
