        ...
        <table style="width:100%;height:100%;table-layout:fixed;">
            <tr>
                <td width="360px" height="60px"><a href="http://www.szjywh.com" target="_blank"><img height="60"
                                                                                                     style="border:0"
                                                                                                     src="${Domain.base}/images/logo_white.jpg"></img></a>
                </td>
...
- <span id="sayHelloSpan"></span>  
                    ...
                    <span><a class="easyui-linkbutton" data-options="iconCls:'user_go',plain:true"
                             href="${Domain.base}/login/exit">退出</a></span>

                    <span><a target="_blank" class="easyui-linkbutton" data-options="iconCls:'house',plain:true"
                             href="${Domain.base}">回到首页</a></span>
