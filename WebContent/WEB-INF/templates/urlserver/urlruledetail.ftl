    ...
    <nav class="navbar navbar-static-top">
        <div class="container">
            <div class="navbar-header">
                <a class="navbar-brand"><b>TC</b>PRO -- 规则详情</a>
            </div>
            <!-- /.navbar-collapse -->
        </div>
        <!-- /.container-fluid -->
...
<div class="content-wrapper">
            ...
            <section class="content">
                <div class="box box-warning">
                    <div class="box-header with-border">
                        <h3 class="box-title">Urlrule 详情页面</h3>
                    </div>
                    ...
                    <div class="box-body">
                        <form id="urlruleedit" name="urlruleedit" class="form-horizontal" role="form" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <label>
                                    <input id="urlshow" name="urlshow" type="text" class="minimal"
                                           value="${urlrule.urlshow}"
                                           hidden="hidden">
                            ...
                            <div class="form-group">
                                ...
                                <select id="projectname" name="projectname" class="form-control select2"
                                        style="width: 20%;">
                            ...
                            <div class="form-group">
                                ...
                                <input id="urlprotocol" name="urlprotocol" type="text" class="form-control"
                                       style="width: 45%;"
                        ...
                        <textarea id="urlroletips" name="urlroletips" class="form-control" rows="1" style="width: 45%;"
                                  placeholder="Enter ...">${urlrule.urlroletips}</textarea>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">规则描述</label>
                        <textarea id="urldesc" name="urldesc" class="form-control" rows="3" style="width: 45%;"
                            ...
                            <div class="form-group">
                                ...
                                <table id="urlparametertable" style="width: 68%;" border='1' cellspacing="1"
                        ...
                        <textarea id="urldemo" name="urldemo" class="form-control" rows="3" style="width: 45%;"
                        ...
                        <textarea id="urlremark" name="urlremark" class="form-control" rows="4" style="width: 45%;"
    ...
    <script>
        ...
        function addRow(paramte) {
            ...
            newNameTD.innerHTML = "<input name='key' style='width: 60px;' id='key' type='text' value='" + paramte.key + "'/>";
            var newNameTD = newTR.insertCell(1);
            newNameTD.innerHTML = "<input name='value' style='width: 140px;' id='value' type='text' value='" + paramte.value + "'/>";
            var newNameTD = newTR.insertCell(2);
            newNameTD.innerHTML = "<input name='remark' style='width: 160px;' id='remark' type='text' value='" + paramte.remark + "'/>";
            var newNameTD = newTR.insertCell(3);
            newNameTD.innerHTML = "<input name='ismust' style='width: 60px;' id='ismust' type='text' value='" + paramte.ismust + "'/>";
            var newNameTD = newTR.insertCell(4);
            newNameTD.innerHTML = "<input name='version' style='width: 60px;' id='version' type='text' value='" + paramte.version + "'/>";
        }
