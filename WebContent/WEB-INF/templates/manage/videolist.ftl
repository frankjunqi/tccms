...
<table id="link-dg" class="easyui-datagrid" title="视频链接管理"
       data-options="rownumbers:true,method:'get',
    toolbar:'#toolbar_link',
    url:'${Domain.base}/manage/videoList/json',
    pagination:true,
    pageSize:20,
    iconCls:'link',
    ...
    <tr>
        ...
        <th data-options="field:'desc',width:200">视频描述</th>
        <#--<th data-options="field:'url',width:490">视频链接</th>-->
    ...
    function deleteLinkId() {
        ...
        if (rows.length == 0) {
            ...
            $.messager.confirm('提示！', '确认要删除数据ID：' + sid, function (r) {
                if (r) {
                    $.get("${Domain.base}/manage/videoList/delete", {id: sid},
                            function (data) {
...
<div id="link-add" class="easyui-window" title="添加视频链接" data-options="iconCls:'link_add',closed:true"
    ...
    <div class="easyui-panel">
        ...
        <form id="link-add-f" method="post">
            <table cellpadding="5">
                ...
                <tr>
                    <td>视频描述:</td>
                    <td><input class="easyui-textbox" name="desc" data-options="required:true"></td>
                </tr>

                <tr>
                    <td>视频链接:</td><#--,validType:'url'-->
                    <td><input class="easyui-textbox" name="url" data-options="required:true"
            ...
            <script>
                function submitFormLinkAdd() {
                    $('#link-add-f').form('submit', {
                        url: '${Domain.base}/manage/videoList/add',
                        onSubmit: function () {
                            // do some check
        ...
        <script>
            ...
            function submitLinkUpdate() {
                $('#link-update-f').form('submit', {
                    url: '${Domain.base}/manage/videoList/edit',
                    onSubmit: function () {
