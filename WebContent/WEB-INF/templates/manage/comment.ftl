...
<div id="comment-add" class="easyui-window" title="添加信息" data-options="iconCls:'comment_add',closed:true"
...
<div id="comment-update" class="easyui-window" data-options="iconCls:'comment_edit',closed:true"
     style="width:900px;padding:10px;">
