...
<div id="nav-add" class="easyui-window" title="添加用户" data-options="iconCls:'basket_add',closed:true"
            ...
            <table cellpadding="5">
                ...
                <tr>
                    ...
                    <td><input class="easyui-combobox" name="menu"
                               data-options="valueField:'id',textField:'name',url:'${Domain.base}/manage/nav/menujson'">
                        如果为顶级，就不需要选择！
                    </td>
                </tr>
                <tr>
...
<div id="nav-update" class="easyui-window" data-options="iconCls:'user_edit',closed:true"
