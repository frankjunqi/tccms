...
<div id="user-add" class="easyui-window" title="添加用户" data-options="iconCls:'user_add',closed:true"
...
<div id="user-update" class="easyui-window" data-options="iconCls:'user_edit',closed:true"
